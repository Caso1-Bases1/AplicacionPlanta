...
public class SystemStructures {
    ...
    private List<Planilla> contenidoPlanilla;
    ...
    public SystemStructures() {
        ...
        contenidoPlanilla = new ArrayList<>();
    }
    ...
    public List<Planilla> getContenidoPlanilla() {
        return contenidoPlanilla;
    }

    public void setContenidoPlanilla(List<Planilla> contenidoPlanilla) {
        this.contenidoPlanilla = contenidoPlanilla;
    }        
}
