...
public class Utility {
	...
	public static String MODIFY_EMPLOYEE = "{call sp_modificar_codigo_planta(?)}";
	...
	public static String INSERT_EMPLOYEE_TYPE = "{call sp_modificar_codigo_planta(?)}";
	public static String MODIFY_EMPLOYEE_TYPE = "{call sp_modificar_codigo_planta(?)}";
	public static String SEARCH_EMPLOYEE_TYPE = "{call sp_modificar_codigo_planta(?)}";
	public static String DELETE_EMPLOYEE_TYPE = "{call sp_modificar_codigo_planta(?)}";
