...
public class DeleteEmployeeTypeView extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1764002808391412876L;
	...
	public DeleteEmployeeTypeView() {
		...
		btnBuscar.setBounds(107, 229, 89, 23);
		add(btnBuscar);
		...
		btnEliminar.setBounds(255, 229, 89, 23);
		add(btnEliminar);
	}
}
