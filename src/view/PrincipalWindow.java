...
public class PrincipalWindow extends JFrame {
    ...
    public PrincipalWindow() {
        ...
        mntmCargarCalendarioEn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (result) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ya se ha cargado el calendario de este a�o, revise los d�as laborables");
                }
            }
        });
        ...
        JMenu mnPlanilla = new JMenu("Planillas");
        menuBar.add(mnPlanilla);
        
        JMenu mnGenerarPlanilla = new JMenu("Generar planilla");
        mnPlanilla.add(mnGenerarPlanilla);

        JMenuItem mntmPlanilla = new JMenuItem("Nueva Planilla");
        mntmPlanilla.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {               
                PlanillaView planillaView = new PlanillaView();
                contentPane.removeAll();
                contentPane.add(planillaView).setBounds(0, 0, 800, 600);                
            }
        });
        mnGenerarPlanilla.add(mntmPlanilla);
        
        JMenuItem mntmObtenerPlanilla = new JMenuItem("Obtener planilla");
        mntmObtenerPlanilla.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {              
                ObtenerPlanillaView planillaView = new ObtenerPlanillaView();
                contentPane.removeAll();
                contentPane.add(planillaView).setBounds(0, 0, 800, 600);                
            }
        });
        mnGenerarPlanilla.add(mntmObtenerPlanilla);
