...
public class SearchEmployeeView extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3935840240956228108L;
	...
	public SearchEmployeeView() {
		...
		JLabel lblIngresoDeEmpleados = new JLabel("Buscar empleado");
			...
			public void actionPerformed(ActionEvent e) {				
				if (!textField.getText().isEmpty()){
					try {
							...
							Employee employeeInserted = controller.search();
		...
		btnBuscar.setBounds(171, 290, 89, 23);
		add(btnBuscar);
	}
}
