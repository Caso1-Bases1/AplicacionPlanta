...
public class UpdateEmployeeView extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 80400423379706020L;
...
this.setLayout(null);
		...
		JLabel lblIngresoDeEmpleados = new JLabel("Actualizar empleado");
		...
		btnModificar.setBounds(299, 289, 89, 23);
		add(btnModificar);
	}
}
